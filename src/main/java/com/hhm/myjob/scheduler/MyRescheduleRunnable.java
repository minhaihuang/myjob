 ...
 * @Date 2022/5/24
 */
public class MyRescheduleRunnable extends DelegatingErrorHandlingRunnable implements ScheduledFuture<Object>{
    ...
    public MyRescheduleRunnable(Runnable delegate, Trigger trigger, Clock clock, ScheduledExecutorService executor, ErrorHandler errorHandler) {
