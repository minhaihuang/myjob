 ...
 * @Date 2022/5/12
 */
public class CustomTaskScheduler2 extends ThreadPoolTaskScheduler {
    private Map<String, ScheduledFuture<?>> scheduledTasks = new IdentityHashMap<>();

    public CustomTaskScheduler2() {
        super();
        super.initialize();
    }
...
//        ScheduledFuture<?> future = super.schedule(task, trigger);
    ...
    private void putScheduledTasks(Runnable task, ScheduledFuture<?> future) {
        ...
        scheduledTasks.put(runnable.getTarget().getClass().getName(), future);
    }
